...
export default class MovieCard extends Component {
  ...
  render() {
    console.log(posterMap[this.props.poster]) //just doing this.props.poster will return the name "choux-maru-istanbul", but posterMap[this.props.poster] will return its url
    return (
